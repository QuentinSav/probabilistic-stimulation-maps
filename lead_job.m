function lead_job
% - Lead-DBS Job created on 10-Mar-2022 13:55:55 -
% --------------------------------------
...
options.earoot = '/home/brainstimmaps/RESEARCH/04_Codebase/stable/leaddbs-2.5.3/';
options.dicomimp.do = 0;
options.dicomimp.method = 2;
options.assignnii = 0;
...
options.uipatdirs = {'/home/brainstimmaps/Desktop/reconstructions/lead_reconPatient3'};
...
options.prefs.lc.datadir = '/home/brainstimmaps/RESEARCH/04_Codebase/stable/leaddbs-2.5.3/connectomes/';
...
options.prefs.genetics.dbdir = '/home/brainstimmaps/RESEARCH/04_Codebase/stable/leaddbs-2.5.3/templates/space/MNI_ICBM_2009b_NLIN_ASYM/genetics/';
...
options.prefs.machine.checkreg.default = 'DISTAL Minimal (Ewert 2017)@STN_motor';
...
options.prefs.machine.normsettings.ants_numcores = '64';
